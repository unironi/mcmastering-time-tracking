...
Current progress:
- Postgre database set-up: 90% done - just need to add a couple more constraints
- Front-end (browser): < 40% done - need to work on authorization page and admin view for the most part
